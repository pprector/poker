package com.poker.server.framework.tracer.config;

import com.poker.server.framework.common.enums.WebFilterOrderEnum;
import com.poker.server.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "pokerServer.tracer", value = "enable", matchIfMissing = true)
public class PokerServerTracerAutoConfiguration {

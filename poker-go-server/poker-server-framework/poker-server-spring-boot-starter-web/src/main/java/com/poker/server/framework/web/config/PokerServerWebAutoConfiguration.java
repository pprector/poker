package com.poker.server.framework.web.config;
...
import com.poker.server.framework.web.core.filter.CacheRequestBodyFilter;
import com.poker.server.framework.web.core.filter.DemoFilter;
import com.poker.server.framework.web.core.handler.GlobalExceptionHandler;
import com.poker.server.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class PokerServerWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "pokerServer.demo", havingValue = "true")

package com.poker.server.framework.jackson.config;

import com.poker.server.framework.common.util.json.JsonUtils;
import com.poker.server.framework.common.util.json.databind.NumberSerializer;
import com.poker.server.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.poker.server.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class PokerServerJacksonAutoConfiguration {

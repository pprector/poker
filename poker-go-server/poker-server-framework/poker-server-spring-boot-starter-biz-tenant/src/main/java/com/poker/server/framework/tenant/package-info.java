 ...
 *      1）Spring Async：
 *          {@link com.poker.server.framework.quartz.config.PokerServerAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 PokerServerSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.poker.server.framework.tenant;

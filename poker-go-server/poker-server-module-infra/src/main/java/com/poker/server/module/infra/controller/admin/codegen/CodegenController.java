package com.poker.server.module.infra.controller.admin.codegen;
...
import com.poker.server.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.poker.server.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.poker.server.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.poker.server.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.poker.server.module.infra.convert.codegen.CodegenConvert;
...
import com.poker.server.module.infra.service.codegen.CodegenService;
...
import static com.poker.server.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.poker.server.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "pokerServer"),

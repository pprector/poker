package com.poker.server.module.infra.websocket;
...
import com.poker.server.framework.websocket.core.sender.WebSocketMessageSender;
import com.poker.server.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.poker.server.module.infra.websocket.message.DemoReceiveMessage;
import com.poker.server.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 pokerServer.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入

package com.poker.server.module.infra.framework.monitor.config;
 ...
 * 安全配置独立于 {@link com.poker.server.framework.security.config.PokerServerWebSecurityConfigurerAdapter}，

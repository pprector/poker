package com.poker.server.module.infra.controller.admin.job.vo.log;
...
import com.poker.server.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "pokerServer")

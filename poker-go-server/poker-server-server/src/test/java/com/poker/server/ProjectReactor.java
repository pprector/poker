...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.yzhz";
    private static final String ARTIFACT_ID = "pokerServer";
    private static final String PACKAGE_NAME = "com.poker.server";
    private static final String TITLE = "德州扑克酒馆管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.yzhz";
        String artifactIdNew = "pokerServer";
        String packageNameNew = "com.poker.server";
        String titleNew = "德州扑克酒馆管理系统";

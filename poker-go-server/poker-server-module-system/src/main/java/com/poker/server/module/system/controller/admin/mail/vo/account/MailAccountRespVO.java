package com.poker.server.module.system.controller.admin.mail.vo.account;
...
public class MailAccountRespVO {
    ...
    @Schema(description = "邮箱", requiredMode = Schema.RequiredMode.REQUIRED, example = "pokerServeryuanma@123.com")
    private String mail;

    @Schema(description = "用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "pokerServer")

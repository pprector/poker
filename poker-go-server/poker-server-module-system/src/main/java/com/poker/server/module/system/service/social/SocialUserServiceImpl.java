...
import com.poker.server.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import com.poker.server.module.system.dal.dataobject.social.SocialUserBindDO;
import com.poker.server.module.system.dal.dataobject.social.SocialUserDO;
import com.poker.server.module.system.dal.mysql.social.SocialUserBindMapper;
import com.poker.server.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.poker.server.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    public SocialUserDO authSocialUser(Integer socialType, Integer userType, String code, String state) {
        ...
        if (socialUser.getId() == null) {
            ...
            socialUser.clean(); // 避免 updateTime 不更新：https://gitee.com/pokerServercode/pokerServer-boot-mini/issues/ID7FUL

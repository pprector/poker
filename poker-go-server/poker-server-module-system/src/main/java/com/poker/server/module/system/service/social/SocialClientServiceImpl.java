package com.poker.server.module.system.service.social;
...
import com.poker.server.framework.common.util.cache.CacheUtils;
import com.poker.server.framework.common.util.http.HttpUtils;
import com.poker.server.framework.common.util.object.BeanUtils;
import com.poker.server.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.poker.server.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.poker.server.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.poker.server.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.poker.server.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.poker.server.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.poker.server.module.system.dal.dataobject.social.SocialClientDO;
import com.poker.server.module.system.dal.mysql.social.SocialClientMapper;
import com.poker.server.module.system.dal.redis.RedisKeyConstants;
import com.poker.server.module.system.enums.social.SocialTypeEnum;
import com.poker.server.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.poker.server.framework.common.util.collection.MapUtils.findAndThen;
import static com.poker.server.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.poker.server.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.poker.server.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${poker-server.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${poker-server.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/pokerServer-cloud/pulls/230

package com.poker.server.module.system.controller.admin.socail.vo.client;
...
import com.poker.server.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "pokerServer商城")
